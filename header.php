...
<body>
       ...
       <nav>
    <ul>
      <li class="frst"><img src="Pinterest-logo.png" alt="" width="42px"><span class="hideOnMobile">Blogterest</span></li>
      ...
      <?php else :?>
        ...
        <li class="hideOnMobile"><a class="nvlivk" href="register.php.php">Register</a></li>
